...
class HyperEmbedding:
    def __init__(self,graph,params_dict={
        ...
        self.embeddings = np.array(self.embeddings,dtype='double')
    ...
    def get_embedding(self,images=None):
        ...
        for epoch in range(self.max_epochs):
            for step in range(self.steps-2):
                ...
                neg_neighbors_temp = np.array([negative_neighbors[step],
                    negative_neighbors[step+1],negative_neighbors[step+2]])
